...
<meta charset="utf-8">
	...
	<title>Your Cart | Embellir</title>
	...
	<p id="success"></p>
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				$result = mysqli_query($conn,"select productid, productName, productPrice,Quantity,productPrice*quantity as cost,productPhoto from product NATURAL JOIN cart where personId=".$personID[0]." and orderid=0");
					$i=1;	
