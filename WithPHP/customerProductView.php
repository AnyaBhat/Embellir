...
<head>
	...
	<title>Welcome to our Brochure | Embellir</title>
	...
	<link rel="stylesheet" href="C:\XAMPP\htdocs\Embellir\Footer2.css">
...
<body>
	...
	<header class="text-gray-700 body-font" style="position: sticky;
        ...
        background-color: #FAEDCD;">
            ...
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                <img class="ml-3 text-xl logo-img-top" src="logo.png" style="height: 90px;">           
            </a>
	...
	<div class="forLoggedInCustomer">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2 style="color: #7f5539;"><b>Our Products </b></h2>
					</div>
					<br>
            ...
            <table class="table table-striped table-hover">
                ...
                <td><img src="<?php echo $row["productPhoto"];?>" alt="Photo" style="width:100%; height:100%">
                    <h2><?php echo $row["productName"]; ?></h2>
                    <p><?php echo $row["productDescription"]; ?></p>
                    <h2>Rs.<?php echo $row["productPrice"]; ?></h2>
                    <button class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal" type="button" onclick="setProductClicked('<?php echo $row["productid"]; ?>','<?php echo $row["productName"]; ?>','<?php echo $row["productid"]; ?>','<?php echo $row["productStock"]; ?>','<?php echo $row["productCap"]; ?>')">
                        Add to Cart
                    </button>
                    <?php $i++;?>
                </td>
    ...
    <!-- Add to cart Modal -->
            ...
            <footer style="text-align:center;  margin-bottom:2rem; margin:2rem 0;">
                <hr />
                &copy; 2023 EMBELLIR
