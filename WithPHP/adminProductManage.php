...
<head>
	...
	<title>Listed Products | Embellir</title>
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				<tr>
					...
					<td><img src="<?php echo $row["productPhoto"];?>" alt="Photo" style="width:100%; height:100%;"></td>
					<td>
				...
				<form id="user_form" action="backend/addProduct.php" method="POST">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="number" id="productPrice" name="productPrice" class="form-control" min="200" max=" " required>
						</div>
						<div class="form-group">
							<label>Product Stock : </label>
							<input type="number" id="productStock" name="productStock" class="form-control" min="1" max=" "required>
						</div>
						<div class="form-group">
							<label>Product Cap (Max Order Qty.) : </label>
							<input type="number" id="productCap" name="productCap" class="form-control" min="1" max="5"required>
						</div>
						<div class="form-group">
