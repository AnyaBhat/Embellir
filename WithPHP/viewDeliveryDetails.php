...
<head>
	...
	<title>orderlist details | Embellir</title>
	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2><b>Order details </b><br> Order ID: <?php echo $deliveryIDforModal ?></h2>
					</div>
					<br>
            ...
            <table id="table" class="table table-striped table-hover">
				...
				$result = $conn->query("select product.productID,product.productName,product.productPrice, product.productPhoto,cart.quantity,cart.cost from product,cart where cart.productID=product.productID and cart.orderid=".$deliveryIDforModal);
					$i=1;
