...
<head>
	...
	<title>Your Orders | Embellir</title>
	...
	<p id="success"></p>
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				$result = mysqli_query($conn,"select orderid, deliveryStatus, deliveryDate,totalCost from orderlist where personid=".$personID[0]);
					$i=1;
				...
				<tr>
                    ...
                    <form action="viewDeliveryDetails.php" method="POST">
                        <input type="hidden" name="viewDetailsID" value="<?php echo $row["orderid"] ; ?>">
